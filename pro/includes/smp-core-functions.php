...
function smp_get_itunes_categories() {
	return array(
		''                             => '--- None ---',
		'arts'                         => __( 'Arts', 'sermon-manager' ),
		'business'                     => __( 'Business', 'sermon-manager' ),
		'comedy'                       => __( 'Comedy', 'sermon-manager' ),
		'education'                    => __( 'Education', 'sermon-manager' ),
		'games_and_hobbies'            => __( 'Games & Hobbies', 'sermon-manager' ),
		'government_and_organizations' => __( 'Government & Organizations', 'sermon-manager' ),
		'health'                       => __( 'Health', 'sermon-manager' ),
		'kids_and_family'              => __( 'Kids &amp; Family', 'sermon-manager' ),
		'music'                        => __( 'Music', 'sermon-manager' ),
		'news_and_politics'            => __( 'News &amp; Politics', 'sermon-manager' ),
		'religion_and_spirituality'    => __( 'Religion & Spirituality', 'sermon-manager' ),
		'science_and_medicine'         => __( 'Science & Medicine', 'sermon-manager' ),
		'society_and_culture'          => __( 'Society & Culture', 'sermon-manager' ),
		'sports_and_recreation'        => __( 'Sports & Recreation', 'sermon-manager' ),
		'technology'                   => __( 'Technology', 'sermon-manager' ),
		'tv_and_film'                  => __( 'TV & Film', 'sermon-manager' ),
	);
}
