...
if ( '1' == $settings->show_filters ) {
	...
	echo $content; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filter form HTML generated by render_wpfc_sorting().
}
?>

<div class="<?php echo esc_attr( $container_class ); ?>" <?php if ( '1' == $settings->show_masonry ) { echo ' data-masonry=\'{ "gutter": 24 }\' '; } ?> >
					...
					<?php if ( 'image' == $settings->featured_type ) : ?>
						<div class="wpfc-sermon-image">
							<a href="<?php the_permalink(); ?>">
								<img src="<?php echo esc_url( get_sermon_image_url( true ) ); ?>" alt="<?php the_title(); ?>">
						...
						<div class="wpfc-sermon-header-main">
							...
							<?php if ( '1' == $settings->show_date ) : ?>
								<div class="wpfc-sermon-meta-item wpfc-sermon-meta-date">
									...
									<?php else : ?>
										<?php echo esc_html( \SM_Dates::get( $settings->date_format ) ); ?>
									<?php endif; ?>
								</div>
							<?php endif; ?>
						</div>
					...
					<div class="wpfc-sermon-description">
						<?php if ( '1' == $settings->show_description ) : ?>
							<div class="sermon-description">
								...
								<?php else : ?>
									<?php echo esc_html( wp_trim_words( get_wpfc_sermon_meta( 'sermon_description' ), $settings->description_length ) ); ?>
								<?php endif; ?>
							</div>
							<?php if ( ( ( str_word_count( get_wpfc_sermon_meta( 'sermon_description' ) ) > $settings->description_length ) ) && ( '1' == $settings->show_more_link ) ) : ?>
								<div class="wpfc-sermon-description-read-more">
									<a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( $settings->more_link_text ); ?></a>
								</div>
							<?php endif; ?>
						<?php endif; ?>
					</div>
						...
						<?php if ( '1' == $settings->show_download_audio ) : ?>
							<div class="smpro-meta-item smpro-meta-item_type_sermon-audio">
								<a class="smpro-meta-item__text smpro-meta-item__text_linked wpfc-sermon-att-audio dashicons dashicons-media-audio"
										href="#" download="<?php echo esc_url( $sermon_audio_url ); ?>" title="Audio"></a>
							</div>
						<?php endif; ?>
					<?php endif; ?>
