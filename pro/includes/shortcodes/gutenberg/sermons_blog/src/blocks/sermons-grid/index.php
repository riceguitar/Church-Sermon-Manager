...
function sermons_blog_layout_render_sermons_grid( $attributes ){
	...
	echo '<div class="' . esc_attr( $gridViewWrapper ) . ' ' . esc_attr( $attributes['gridLayoutStyle'] ) . '" style="--item-padding-left-right : ' . esc_attr( $attributes['columnGap'] ) . 'px; --item-margin-bottom : ' . esc_attr( $attributes['columnGap']*2 ) . 'px; --item-height : ' . esc_attr( 300-$attributes['columnGap'] ) . 'px">';
	...
	echo '<div class="' . esc_attr($parentClasses) . '" ' . $masonryLayout . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $masonryLayout is a fixed data-masonry attribute string defined above.
		...
		if ( $the_query->have_posts() ) {
			while ( $the_query->have_posts() ) {
				...
				echo '<article id="post-' . esc_attr( get_the_ID() ) . '" class="' . esc_attr( $gridView ) . ' ' . esc_attr( $attributes['gridLayoutStyle'] ) . ' ' . esc_attr( join(' ', get_post_class( )) ). '">'; 
				echo '<div class="wpfc-sermon-inner ' . esc_attr( $attributes['align'] ) . esc_attr( $equalHeight ) . ' image-position-' . esc_attr( $attributes['imagePosition'] ) . '">'; ?>
						...
						<div class="wpfc-sermon-main <?php echo get_sermon_image_url() ? '' : 'no-image'; ?>">
							<div class="wpfc-sermon-header">
								<div class="wpfc-sermon-header-main">
									...
									<h3 class="wpfc-sermon-title" <?php echo 'style="padding-bottom:' . esc_attr( $attributes['titlePadding'] ) . 'px;"'; ?>>
							...
							<div class="wpfc-sermon-description">
								<?php if ( $attributes['displaySermonDescription'] ) : ?>
									<div class="sermon-description-content" <?php echo 'style="padding-bottom:' . esc_attr( $attributes['descriptionPadding'] ) . 'px;"'; ?>>
										<?php if ( has_excerpt() ) : ?>
										...
										<?php else : ?>
											<?php echo esc_html( wp_trim_words( get_wpfc_sermon_meta( 'sermon_description' ), 30 ) ); ?>
										<?php endif; ?>
									</div>
									<?php if ( ( str_word_count( get_wpfc_sermon_meta( 'sermon_description' ) ) > 30 ) && ( $attributes['displaySermonReadMoreButton'] ) ) : ?>
										<div class="wpfc-sermon-description-read-more">
											<a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( $attributes['postReadMoreButtonText'] ); ?></a>
										</div>
									<?php endif; ?>
								<?php endif; ?>
							</div>
	...
	echo '</div>';
		    ...
		    if ( ( $paginate_links ) && ( isset( $attributes['displayPagination'] ) ) && ( $attributes['displayPagination'] ) ) {
				?>
				<nav class="gutenberg-pagination custom-pagination" style="text-align:<?php echo esc_attr( $attributes['paginationAlignment'] ); ?>;">
