...
class VC_Blog {
	...
	public static function render( $atts = array() ) {
		...
		if ( $args['show_filters'] ) {
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filter form HTML generated by render_wpfc_sorting().
		...
		if ( $the_query->have_posts() ) {
			while ( $the_query->have_posts() ) {
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?>
					<?php echo 'on' === $args['show_grid'] ? 'style="margin-right:' . esc_attr( $args['spacing_columns'] ) . 'px;width: calc((100% - ' . esc_attr( $args['spacing_columns'] * ( $args['grid_columns'] - 1 ) ) . 'px) / ' . esc_attr( $args['grid_columns'] ) . ');"' : ''; ?>>
								...
								<div class="wpfc-sermon-image">
									<a href="<?php the_permalink(); ?>">
										<div class="wpfc-sermon-image-img"
												style="background-image: url(<?php echo esc_url( get_sermon_image_url( true ) ); ?>)"></div>
									</a>
								</div>
							<?php endif; ?>
						...
						<div class="wpfc-sermon-main <?php echo get_sermon_image_url() ? '' : 'no-image'; ?>">
							<div class="wpfc-sermon-header">
								<div class="wpfc-sermon-header-main">
									...
									<?php if ( $args['show_title'] ) : ?>
										<h3 class="wpfc-sermon-title" <?php echo 'style="padding-bottom:' . esc_attr( $args['title_padding'] ) . 'px;"'; ?>>
									...
									<?php if ( $args['show_date'] ) : ?>
										<div class="wpfc-sermon-meta-item wpfc-sermon-meta-date">
											...
											<?php else : ?>
												<?php echo esc_html( \SM_Dates::get( $args['date_format'] ) ); ?>
											<?php endif; ?>
										</div>
									<?php endif; ?>
								</div>
							...
							<div class="wpfc-sermon-description">
								<?php if ( $args['show_excerpt'] ) : ?>
									<div class="sermon-description-content" <?php echo 'style="padding-bottom:' . esc_attr( $args['description_padding'] ) . 'px;"'; ?>>
										<?php if ( has_excerpt() ) : ?>
										...
										<?php else : ?>
											<?php echo esc_html( wp_trim_words( get_wpfc_sermon_meta( 'sermon_description' ), $args['excerpt_length'] ) ); ?>
										<?php endif; ?>
									</div>
									<?php if ( ( str_word_count( get_wpfc_sermon_meta( 'sermon_description' ) ) > $args['excerpt_length'] ) && $args['show_readmore'] ) : ?>
										<div class="wpfc-sermon-description-read-more">
											<a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( $args['read_more_text'] ); ?></a>
										</div>
									<?php endif; ?>
								<?php endif; ?>
							</div>
			...
			if ( ( $paginate_links ) && $args['show_pagination'] ) {
				?>
				<nav class="custom-pagination" style="text-align:<?php echo esc_attr( $args['pagination_alignment'] ); ?>;">
