...
function wpfc_sermon_metaboxes() {
	...
	$sermon_details_meta = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Sermon Details', 'church-sermon-manager' ),
	...
	$sermon_details_meta->add_field( array(
		'name'         => esc_html__( 'Date Preached', 'church-sermon-manager' ),
		// translators: %s date format, effectively <code>d/m/Y</code> or the like.
		'desc'         => esc_html__( '(optional)', 'church-sermon-manager' ) . '<br>' . wp_sprintf( esc_html__( 'format: %s', 'church-sermon-manager' ), $date_format_label ),
		'id'           => 'sermon_date',
	...
	$sermon_details_meta->add_field( array(
		...
		'desc'             => wp_sprintf( esc_html__( 'Select the %1$s. Modify the %2$s %3$s.', 'church-sermon-manager' ), strtolower( sm_get_taxonomy_field( 'wpfc_service_type', 'singular_name' ) ), strtolower( sm_get_taxonomy_field( 'wpfc_service_type', 'label' ) ), '<a href="' . admin_url( 'edit-tags.php?taxonomy=wpfc_service_type&post_type=wpfc_sermon' ) . '" target="_blank">here</a>' ),
	...
	$sermon_details_meta->add_field( array(
		'name' => esc_html__( 'Main Bible Passage', 'church-sermon-manager' ),
		...
		'desc' => wp_sprintf( esc_html__( 'Enter the Bible passage with the full book names, e.g. %1$s Or multiple books like %2$s', 'church-sermon-manager' ), '<code>' . esc_html__( 'John 3:16-18', 'church-sermon-manager' ) . '</code><br>', '<code>' . esc_html__( 'John 3:16-18, Luke 2:1-3', 'church-sermon-manager' ) . '</code>' ),
		'id'   => 'bible_passage',
		'type' => 'text',
	) );
	// $sermon_details_meta->add_field( array(
	// 	'name'    => esc_html__( 'Description', 'church-sermon-manager' ),
	// 	'desc'    => esc_html__( 'Type a brief description about this sermon, an outline, or a full manuscript', 'church-sermon-manager' ),
	...
	$sermon_files_meta = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Sermon Files', 'church-sermon-manager' ),
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Location of MP3', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Upload an audio file or enter an URL.', 'church-sermon-manager' ),
		'id'   => 'sermon_audio',
		'type' => 'file',
		'text' => array(
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'MP3 Duration', 'church-sermon-manager' ),
		// translators: %s see msgid "hh:mm:ss", effectively <code>hh:mm:ss</code>.
		'desc' => wp_sprintf( esc_html__( 'Length in %s format (fill out only for remote files, local files will get data calculated by default)', 'church-sermon-manager' ), '<code>' . esc_html__( 'hh:mm:ss', 'church-sermon-manager' ) . '</code>' ),
		'id'   => '_wpfc_sermon_duration',
		'type' => 'text',
	) );
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Video Embed Code', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Paste your embed code for Vimeo, Youtube, Facebook, or direct video file here', 'church-sermon-manager' ),
		'id'   => 'sermon_video',
		'type' => 'textarea_code',
	) );
	$sermon_files_meta->add_field( apply_filters( 'sm_cmb2_field_sermon_video_link', array(
		'name' => esc_html__( 'Video Link', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Paste your link for Vimeo, Youtube, Facebook, or direct video file here', 'church-sermon-manager' ),
		'id'   => 'sermon_video_link',
		'type' => 'text_url',
	) ) );
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Single Sermon Note', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Upload  pdf file.', 'church-sermon-manager' ),
		'id'   => 'sermon_notes',
		'type' => 'file',
		'text' => array(
			'add_upload_file_text' => esc_html__( 'Add File', 'church-sermon-manager' ),
			// Change upload button text. Default: "Add or Upload File".
		),
	) );
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Multiple Sermon Notes', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Upload  pdf files.', 'church-sermon-manager' ),
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Single Bulletin', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Upload a pdf file.', 'church-sermon-manager' ),
		'id'   => 'sermon_bulletin',
		'type' => 'file',
		'text' => array(
			'add_upload_file_text' => esc_html__( 'Add File', 'church-sermon-manager' ),
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Multiple Bulletin', 'church-sermon-manager' ),
		'desc' => esc_html__( 'Upload pdf files.', 'church-sermon-manager' ),
