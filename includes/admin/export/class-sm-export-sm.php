...
class SM_Export_SM {
	...
	function sermon_export_wp( $args = array() ) {
		...
		function wxr_cat_name( $category ) {
			...
			echo '<wp:cat_name>' . wxr_cdata( $category->name ) . '</wp:cat_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_category_description( $category ) {
			...
			echo '<wp:category_description>' . wxr_cdata( $category->description ) . '</wp:category_description>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_tag_name( $tag ) {
			...
			echo '<wp:tag_name>' . wxr_cdata( $tag->name ) . '</wp:tag_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_tag_description( $tag ) {
			...
			echo '<wp:tag_description>' . wxr_cdata( $tag->description ) . '</wp:tag_description>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_term_name( $term ) {
			...
			echo '<wp:term_name>' . wxr_cdata( $term->name ) . '</wp:term_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_term_description( $term ) {
			...
			echo '<wp:term_description>' . wxr_cdata( $term->description ) . '</wp:term_description>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
		}
		...
		function wxr_authors_list() {
			...
			foreach ( $authors as $author ) {
				echo "\t<wp:author>";
				echo '<wp:author_id>' . esc_xml( $author->ID ) . '</wp:author_id>';
				...
				echo '<wp:author_display_name>' . wxr_cdata( $author->display_name ) . '</wp:author_display_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
				echo '<wp:author_first_name>' . wxr_cdata( $author->user_firstname ) . '</wp:author_first_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
				echo '<wp:author_last_name>' . wxr_cdata( $author->user_lastname ) . '</wp:author_last_name>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
				echo "</wp:author>\n";
			}
		}
		...
		echo '<?xml version="1.0" encoding="' . esc_xml( get_bloginfo( 'charset' ) ) . "\" ?>\n";
		...
		>
			...
			<channel>
				...
				<pubDate><?php echo esc_xml( gmdate( 'D, d M Y H:i:s +0000' ) ); ?></pubDate>
					...
					<wp:term>
						...
						foreach ( $termmeta as $meta ) :
							...
							<wp:termmeta>
								...
								<wp:meta_value><?php echo wxr_cdata( $meta->meta_value ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata(). ?></wp:meta_value>
							</wp:termmeta>
						<?php endforeach; ?>
						<?php if ( array_key_exists( $t->term_id, $assigned_term_images ) ) { ?>
							<wp:termmeta>
								<wp:meta_key>sm_term_image_id</wp:meta_key>
								<wp:meta_value><?php echo esc_xml( $assigned_term_images[ $t->term_id ] ); ?></wp:meta_value>
							</wp:termmeta>
						<?php } ?>
					</wp:term>
				<?php endforeach; ?>
					...
					while ( $next_posts = array_splice( $post_ids, 0, 20 ) ) {
						...
						foreach ( $posts as $post ) {
							...
							<item>
								...
								<title><?php echo apply_filters( 'the_title_rss', $post->post_title ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- the_title_rss filter chain applies strip_tags/esc_html in core. ?></title>
								<link><?php the_permalink_rss(); ?></link>
								<pubDate><?php echo esc_xml( mysql2date( 'D, d M Y H:i:s +0000', get_post_time( 'Y-m-d H:i:s', true ), false ) ); ?></pubDate>
								<dc:creator><?php echo wxr_cdata( get_the_author_meta( 'login' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata(). ?></dc:creator>
								...
								<content:encoded>
									 ...
									 */
									echo wxr_cdata( apply_filters( 'the_content_export', $post->post_content ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
									?>
								</content:encoded>
								<excerpt:encoded>
									<?php
									 ...
									 */
									echo wxr_cdata( apply_filters( 'the_excerpt_export', $post->post_excerpt ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata().
									?>
								</excerpt:encoded>
								<wp:post_id><?php echo esc_xml( $post->ID ); ?></wp:post_id>
								<wp:post_content><?php echo wxr_cdata( $post->post_content ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata(). ?></wp:post_content>
								...
								<wp:post_parent><?php echo esc_xml( $post->post_parent ); ?></wp:post_parent>
								<wp:menu_order><?php echo esc_xml( $post->menu_order ); ?></wp:menu_order>
								...
								<wp:is_sticky><?php echo esc_xml( $is_sticky ); ?></wp:is_sticky>
								...
								foreach ( $comments as $c ) :
									?>
									<wp:comment>
										<wp:comment_id><?php echo esc_xml( $c->comment_ID ); ?></wp:comment_id>
										<wp:comment_author><?php echo wxr_cdata( $c->comment_author ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata(). ?></wp:comment_author>
										...
										<wp:comment_content><?php echo wxr_cdata( $c->comment_content ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- CDATA-wrapped by wxr_cdata(). ?></wp:comment_content>
										...
										<wp:comment_parent><?php echo esc_xml( $c->comment_parent ); ?></wp:comment_parent>
										<wp:comment_user_id><?php echo esc_xml( $c->user_id ); ?></wp:comment_user_id>
										<?php
