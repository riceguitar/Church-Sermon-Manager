...
<div class="sm wrap">
	<div class="intro">
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Sermon Manager Import/Export', 'church-sermon-manager' ); ?></h1>
	</div>
	<div class="wp-list-table widefat">
		<p><?php esc_html_e( 'We have made it easy to backup, migrate or bring sermons from another plugin. Choose the relevant option below to get started.', 'church-sermon-manager' ); ?></p>
		<div id="the-list">
			<div class="plugin-card card-import-sm">
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Import from file', 'church-sermon-manager' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							<li>
								...
								<?php else : ?>
									...
									<span class="button activate-now" id="sm-import-trigger">
										<span>
											<?php esc_html_e( 'Import', 'church-sermon-manager' ); ?>
										</span>
							...
							<li><a href="https://github.com/riceguitar/Church-Sermon-Manager#readme" class="" target="_blank" rel="noopener"
									...
									<?php esc_html_e( 'More Details', 'church-sermon-manager' ); ?>
								</a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Import sermons from another Sermon Manager installation.', 'church-sermon-manager' ); ?></p>
					</div>
				</div>
			</div>
			<div class="plugin-card card-export-sm">
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Export to file', 'church-sermon-manager' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							...
							<li><a href="https://github.com/riceguitar/Church-Sermon-Manager#readme" class="" target="_blank" rel="noopener"
										aria-label="<?php esc_attr_e( 'More Details', 'church-sermon-manager' ); ?>">
									<?php esc_html_e( 'More Details', 'church-sermon-manager' ); ?></a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Create an export for the purpose of backup or migration to another website.', 'church-sermon-manager' ); ?></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="wp-list-table widefat">
		<h2><?php esc_html_e( 'Import From 3rd Party Plugins', 'church-sermon-manager' ); ?></h2>
		<p><?php esc_html_e( 'You can import sermons from the following plugins into Sermon Manager', 'church-sermon-manager' ); ?></p>
		<div id="the-list">
			<div class="plugin-card <?php echo SM_Import_SB::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Sermon Browser', 'church-sermon-manager' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							...
							<li>
								<a href="https://github.com/riceguitar/Church-Sermon-Manager#readme"
										target="_blank"
										aria-label="<?php esc_attr_e( 'More Details', 'church-sermon-manager' ); ?>">
									<?php esc_html_e( 'More Details', 'church-sermon-manager' ); ?></a>
							</li>
						</ul>
					</div>
					<div class="desc column-description">
						<p>
							...
							echo esc_html( wp_sprintf( __( 'Import your existing %s sermon library into Sermon Manager', 'church-sermon-manager' ), 'Sermon Browser' ) );
							?>
						</p>
						<p class="import-note">
							<?php
							// translators: %s Documentation URL.
							echo wp_sprintf( __( 'Note: Some restrictions apply. Click %s for more details.', 'church-sermon-manager' ), ' <a href="https://github.com/riceguitar/Church-Sermon-Manager#readme" target="_blank">here</a>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Hard-coded anchor markup injected via wp_sprintf() into translated text.
							?>
						</p>
					</div>
				</div>
			...
			<div class="plugin-card <?php echo SM_Import_SE::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Series Engine', 'church-sermon-manager' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
					...
					<div class="desc column-description">
						<p>
							<?php
							// translators: %s Plugin name.
							echo esc_html( wp_sprintf( __( 'Import your existing %s sermon library into Sermon Manager', 'church-sermon-manager' ), 'Series Engine' ) );
							?>
						</p>
						<p class="import-note">
							<?php
	...
	<p class="description">
		<?php esc_html_e( 'Note: We recommend you create a backup of your current database just in case.', 'church-sermon-manager' ); ?>
	</p>
</div>
