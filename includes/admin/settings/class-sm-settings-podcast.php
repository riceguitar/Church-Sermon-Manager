...
class SM_Settings_Podcast extends SM_Settings_Page {
	...
	public function after() {
		...
		<div>
			<p>
				<label for="feed_url"><?php echo esc_html( __( 'Feed URL to Submit to iTunes', 'church-sermon-manager' ) ); ?></label>
			...
			<p>
				...
				echo wp_sprintf( esc_html__( 'Use the %s to diagnose and fix any problems before submitting your Podcast to iTunes.', 'church-sermon-manager' ), '<a href="' . esc_url( 'http://www.feedvalidator.org/check.cgi?url=' . site_url( '/' ) . SermonManager::getOption( 'archive_slug', 'sermons' ) . '/feed/' ) . '" target="_blank">' . esc_html__( 'Feed Validator', 'church-sermon-manager' ) . '</a>' );
				?>
			</p>
			<p>
				<?php
