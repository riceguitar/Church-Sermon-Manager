...
class SM_Post_Types {
	...
	public static function register_taxonomies() {
		...
		$labels = array(
			'wpfc_preacher'     => SermonManager::getOption( 'preacher_label' ) ? strtolower( SermonManager::getOption( 'preacher_label' ) ) : __( 'Preacher', 'sermon-manager' ),
			'wpfc_service_type' => SermonManager::getOption( 'service_type_label' ) ? strtolower( SermonManager::getOption( 'service_type_label' ) ) : __( 'Service Type', 'sermon-manager' ),
		);
			...
			apply_filters(
				...
				array(
					...
					'labels'       => array(
						...
						'search_items'      => wp_sprintf( __( 'Search %s', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						/* translators: %s preacher */
						'all_items'         => wp_sprintf( __( 'All %s', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						'parent_item'       => null,
						'parent_item_colon' => null,
						/* translators: %s preacher */
						'edit_item'         => wp_sprintf( __( 'Edit %s', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						/* translators: %s preacher */
						'update_item'       => wp_sprintf( __( 'Update %s', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						/* translators: %s preacher */
						'add_new_item'      => wp_sprintf( __( 'Add new %s', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						/* translators: %s preacher */
						'new_item_name'     => wp_sprintf( __( 'New %s name', 'sermon-manager' ), $labels['wpfc_preacher'] ),
						/* translators: %s preacher */
						'not_found'         => wp_sprintf( __( 'No %s found', 'sermon-manager' ), $labels['wpfc_preacher'] ),
					),
					'show_ui'      => true,
					'query_var'    => true,
					'show_in_rest' => true,
			...
			apply_filters(
				...
				array(
					...
					'labels'       => array(
						...
						'menu_name'         => _x( 'Series', 'menu', 'sermon-manager' ),
			...
			apply_filters(
				...
				array(
					...
					'labels'       => array(
						...
						'menu_name'         => _x( 'Topics', 'menu', 'sermon-manager' ),
			...
			apply_filters(
				...
				array(
					...
					'labels'       => array(
						...
						'menu_name'         => _x( 'Books', 'menu', 'sermon-manager' ),
			...
			apply_filters(
				...
				array(
					...
					'labels'       => array(
						...
						/* translators: %s preacher */
						'search_items'      => wp_sprintf( __( 'Search %s', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						/* translators: %s preacher */
						'all_items'         => wp_sprintf( __( 'All %s', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						'parent_item'       => null,
						'parent_item_colon' => null,
						/* translators: %s preacher */
						'edit_item'         => wp_sprintf( __( 'Edit %s', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						/* translators: %s preacher */
						'update_item'       => wp_sprintf( __( 'Update %s', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						/* translators: %s preacher */
						'add_new_item'      => wp_sprintf( __( 'Add new %s', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						/* translators: %s preacher */
						'new_item_name'     => wp_sprintf( __( 'New %s name', 'sermon-manager' ), $labels['wpfc_service_type'] ),
						/* translators: %s preacher */
						'not_found'         => wp_sprintf( __( 'No %s found', 'sermon-manager' ), $labels['wpfc_service_type'] ),
					),
					'show_ui'      => true,
					'query_var'    => true,
					'show_in_rest' => true,
			...
			apply_filters(
				...
				array(
					'labels'              => array(
						...
						'all_items'             => __( 'Sermons', 'sermon-manager' ),
						'menu_name'             => _x( 'Sermons', 'menu', 'sermon-manager' ),
						...
						'insert_into_item'      => __( 'Insert to sermon', 'sermon-manager' ),
