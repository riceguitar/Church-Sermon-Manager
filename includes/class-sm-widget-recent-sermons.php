...
class SM_Widget_Recent_Sermons extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'The most recent sermons on your site', 'church-sermon-manager' ),
		);
		parent::__construct( 'recent-sermons', __( 'Recent Sermons', 'church-sermon-manager' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( SM_OB_ENABLED ) {
			...
			$title         = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Recent Sermons', 'church-sermon-manager' ) : $instance['title'], $instance, $this->id_base );
