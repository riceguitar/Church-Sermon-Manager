...
class PostTypes {
            ...
            apply_filters(
                ...
                [
                    'labels'              => [
                        ...
                        'add_new'            => __('Add Sermon', 'sermon-manager'),
    ...
    public function register_taxonomies(): void {
        ...
        $labels = [
            'wpfc_preacher'     => Plugin::getOption('preacher_label') ? strtolower(Plugin::getOption('preacher_label')) : __('Preacher', 'sermon-manager'),
            'wpfc_service_type' => Plugin::getOption('service_type_label') ? strtolower(Plugin::getOption('service_type_label')) : __('Service Type', 'sermon-manager'),
        ];
