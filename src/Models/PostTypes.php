...
class PostTypes {
            ...
            apply_filters(
                ...
                [
                    'labels'              => [
                        ...
                        'add_new'            => __('Add Sermon', 'church-sermon-manager'),
                        ...
                        'search_items'       => __('Search Sermons', 'church-sermon-manager'),
    ...
    public function register_taxonomies(): void {
        ...
        $labels = [
            'wpfc_preacher'     => Plugin::getOption('preacher_label') ? strtolower(Plugin::getOption('preacher_label')) : __('Preacher', 'church-sermon-manager'),
            'wpfc_service_type' => Plugin::getOption('service_type_label') ? strtolower(Plugin::getOption('service_type_label')) : __('Service Type', 'church-sermon-manager'),
        ];
