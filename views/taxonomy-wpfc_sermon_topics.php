...
if ( have_posts() ) :
	...
	echo apply_filters( 'taxonomy-wpfc_sermon_topics-before-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
	...
	echo apply_filters( 'taxonomy-wpfc_sermon_topics-after-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
