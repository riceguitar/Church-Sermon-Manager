...
if ( have_posts() ) :
	...
	echo apply_filters( 'taxonomy-wpfc_bible_book-before-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
	...
	echo apply_filters( 'taxonomy-wpfc_bible_book-after-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
