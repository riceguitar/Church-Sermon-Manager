...
if ( have_posts() ) :
	...
	echo apply_filters( 'taxonomy-wpfc_service_type-before-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
	...
	echo apply_filters( 'taxonomy-wpfc_service_type-after-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- filterable markup slot (frozen public filter name).
