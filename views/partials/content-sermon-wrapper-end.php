...
switch ( $template ) {
	...
	case 'uncode':
		if ( ! is_single() ) {
          ...
          <div class="post-wrapper">
			...
			$the_content .= ob_get_clean();
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- markup generated by the active Uncode theme's own helpers.
	...
	default:
		...
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- intentional wrapper markup, filterable by themes via sm_templates_wrapper_end.
